        ...
        <div className=" flex justify-between p-[.6rem_2rem_.9rem] text-xl items-center hover:bg-[#0000002b] max-[665px]:h-[80px]">
            ...
            <aside className="flex ">
                ...
                <div className="text-center flex items-center">
                    <img src="level-logo.png" alt="Imagen que representa el nivel" className="h-[65px] p-2 max-[665px]:h-[35px]" />
                    <p type="text" className="p-2 text-center m-[0_6px] rounded-xl w-[40px]" >{level}</p>
                ...
                <div className="text-center flex items-center p-[0_2rem]">
                    <p className="p-2 flex items-center"><img src="mochila.png" alt="" className="h-[65px] p-2 max-[665px]:h-[35px]" />: {object}</p>
                ...
                <span className="flex items-center text-xl"><img src="dano-logo.png" alt="" className="h-[65px] p-2 max-[665px]:h-[35px]" />: {total}</span>
            </aside>
