        ...
        <div className=" flex justify-between p-[.5rem_2rem] text-3xl items-center cursor-pointer hover:bg-[#0000002b]">
            ...
            <aside className="flex gap-x-3">
                <div className="text-center flex items-center">
                    <p className="p-2 flex items-center"><img src="./public/images/level-logo.png" alt="Imagen que representa el nivel" className="h-[65px] p-2" />: {level}</p>
                ...
                <div className="text-center flex items-center p-[0_2rem]">
                    <p className="p-2 flex items-center"><img src="./public/images/mochila.png" alt="" className="h-[65px] p-2" />: {object}</p>
                    <div className="text-sm flex flex-col-reverse gap-2">
                        <button onClick={() => handleObjectDown()}>↓</button>
                        <button onClick={() => handleObjectUp()}>↑</button>
                    </div>
                </div>
                <span className="flex items-center text-4xl"><img src="./public/images/dano-logo.png" alt="" className="h-[65px] p-2" />: {total}</span>
            </aside>
